...
public class AdminUI {
    ...
    private void viewAllInvoices() {
        ...
        while (invIt.hasNext()) {
            ...
            if (found != null) {
                ...
                System.out.printf("%-10s | %-11s | %-10s | %-21s | %-10s | %s%n",
                    inv.getInvoiceID(),
                    found.getVisitID(),
                    patientId,
    ...
    private void viewAllServices() {
        ...
        while (it.hasNext()) {
            Service s = it.next();
            System.out.printf("%-6s | %-30s | %-9s | RM %7.2f | %s%n",
                s.getServiceID(),
